...
import com.demo.app.activitylifecycles.ArouterActivityLifecycle;
import com.demo.app.activitylifecycles.DefaultActivityLifecycle;
import com.demo.app.activitylifecycles.PortraitActivityLifecycle;
import com.demo.app.activitylifecycles.StatusBarActivityLifecycle;
import com.demo.app.applifecycles.ArouterAppLifecycle;
import com.demo.app.applifecycles.BuglyAppLifecycle;
import com.demo.app.applifecycles.DefaultAppLifecycle;
import com.demo.app.applifecycles.ToastAppLifecycle;
import com.demo.app.fragmentlifecycles.DefaultFragmentLifecycle;
 ...
 * Created by MVPArmsTemplate on 11/04/2019 14:15
...
//                    RetrofitUrlManager.getInstance().with(okhttpBuilder);
    ...
    public void injectAppLifecycle(Context context, List<AppLifecycles> lifecycles) {
        ...
        //可以根据不同的逻辑添加多个实现类
        lifecycles.add(new DefaultAppLifecycle());
        lifecycles.add(new BuglyAppLifecycle());
        lifecycles.add(new ArouterAppLifecycle());
        lifecycles.add(new ToastAppLifecycle());
    }
    ...
    public void injectActivityLifecycle(Context context, List<Application.ActivityLifecycleCallbacks> lifecycles) {
        ...
        //可以根据不同的逻辑添加多个实现类
        lifecycles.add(new DefaultActivityLifecycle());
        lifecycles.add(new PortraitActivityLifecycle());
        lifecycles.add(new ArouterActivityLifecycle());
        lifecycles.add(new StatusBarActivityLifecycle());
    }
    ...
    public void injectFragmentLifecycle(Context context, List<FragmentManager.FragmentLifecycleCallbacks> lifecycles) {
        ...
        //可以根据不同的逻辑添加多个实现类
        lifecycles.add(new DefaultFragmentLifecycle());
    }
}
